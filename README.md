...
独立的 [SimeApp](https://github.com/Ismantic/SimeApp) 仓库。三端已经
是本项目开发者的日常使用输入法，且自认为输入准确率已经不弱于商业闭源了，推荐有兴趣者试用。

## 目标
完全端上，输入准确率媲美商业闭源输入法（比如微信/豆包输入法）。
